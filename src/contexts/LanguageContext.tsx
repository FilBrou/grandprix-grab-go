...
const translations = {
  ...
  zh: {
    ...
    'orders.allStatuses': '全部',
    'orders.pending': '待处理',
    'orders.confirmed': '已确认',
    'orders.ready': '已准备',
    'orders.completed': '已完成',
    'orders.cancelled': '已取消',
    'orders.sortByDate': '按日期排序',
    'orders.noMatchingOrders': '没有匹配的订单。',
    'orders.totalItems': '商品',
    'orders.items': '件',
    'orders.orderDetails': '订单摘要',
    'orders.orderItems': '您的商品',
    'orders.product': '产品',
    'orders.unitPrice': '价格',
    'orders.subtotal': '小计',
    'orders.collectionPoint': '取货地点',
  ...
  hi: {
    ...
    // Orders
    'orders.history': 'मेरे ऑर्डर',
    'orders.noOrders': 'अभी कोई ऑर्डर नहीं',
    'orders.id': 'ID',
    'orders.products': 'उत्पाद',
    'orders.quantity': 'मात्रा',
    'orders.date': 'तारीख',
    'orders.status': 'स्थिति',
    'orders.total': 'कुल',
    'orders.filterByStatus': 'स्थिति के अनुसार फ़िल्टर करें',
    'orders.allStatuses': 'सभी',
    'orders.pending': 'लंबित',
    'orders.confirmed': 'पुष्टि',
    'orders.ready': 'तैयार',
    'orders.completed': 'पूर्ण',
    'orders.cancelled': 'रद्द',
    'orders.sortByDate': 'तारीख के अनुसार क्रमबद्ध करें',
    'orders.noMatchingOrders': 'कोई मिलान नहीं।',
    'orders.totalItems': 'आइटम',
    'orders.items': 'आइटम',
    'orders.orderDetails': 'ऑर्डर सारांश',
    'orders.orderItems': 'आपके आइटम',
    'orders.product': 'उत्पाद',
    'orders.unitPrice': 'मूल्य',
    'orders.subtotal': 'उप-योग',
    'orders.collectionPoint': 'पिकअप स्थान',
  ...
  es: {
    ...
    'orders.allStatuses': 'Todos',
    'orders.pending': 'Pendiente',
    'orders.confirmed': 'Confirmado',
    'orders.ready': 'Listo',
    'orders.completed': 'Completado',
    'orders.cancelled': 'Cancelado',
    'orders.sortByDate': 'Ordenar por fecha',
    'orders.noMatchingOrders': 'No hay pedidos que coincidan.',
    'orders.totalItems': 'Artículos',
    'orders.items': 'artículos',
    'orders.orderDetails': 'Resumen del Pedido',
    'orders.orderItems': 'Tus Artículos',
    'orders.product': 'Producto',
    'orders.unitPrice': 'Precio',
    'orders.subtotal': 'Subtotal',
    'orders.collectionPoint': 'Lugar de Recogida',
