...
-- Ajouter une nouvelle contrainte avec toutes les catégories nécessaires
ALTER TABLE items ADD CONSTRAINT items_category_check CHECK (category IN ('food', 'drinks', 'merchandise', 'energy_drinks', 'soft_drinks', 'juices', 'sports_drinks', 'beer', 'wine', 'spirits', 'cocktails'));
